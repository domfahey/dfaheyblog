"""
Django settings for Dominic Fahey Blog project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-QUI7AQNyfMEarseG1DaS3NmCerzV6FhiKx8OYw4R")
...
WSGI_APPLICATION = "dfaheyblog.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="dfaheyblog"),
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="dfaheyblog-media")
...
SERVER_EMAIL = env("SERVER_EMAIL", default="noreply@dominicfahey.com")
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="domfahey@gmail.com")
...
EMAIL_SUBJECT_PREFIX = "[Dominic Fahey Blog] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Dominic Fahey Blog",
    "DESCRIPTION": "Dominic Fahey Personal Blob",
    "VERSION": "0.1.0",
...
WAGTAIL_SITE_NAME = "Dominic Fahey Blog Content"
WAGTAILADMIN_BASE_URL = "http://dominicfahey.com"
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("Dominic Fahey Blog"),
    "URL": "http://dominicfahey.com",
    "DESCRIPTION": gettext_lazy("Dominic Fahey Personal Blob"),
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "domfahey@gmail.com",
}

# set this to True in production to have URLs generated with https instead of http
USE_HTTPS_IN_ABSOLUTE_URLS = env.bool("USE_HTTPS_IN_ABSOLUTE_URLS", default=False)

ADMINS = [("Dominic Fahey", "domfahey@gmail.com")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "dfaheyblog": {
            "handlers": ["console"],
            "level": env("DFAHEYBLOG_LOG_LEVEL", default="INFO"),
        },
    },
}
